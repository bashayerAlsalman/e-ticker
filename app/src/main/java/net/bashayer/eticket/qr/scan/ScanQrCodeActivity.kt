...
class ScanQrCodeActivity : BaseActivity(), ZXingScannerView.ResultHandler {
    ...
    private fun setScannerProperties() {
        ...
        qrCodeScanner.setLaserColor(R.color.secondaryColor)
        qrCodeScanner.setMaskColor(R.color.secondaryColor)
    ...
    private fun showCameraSnackBar() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
            ...
            view1.setBackgroundColor(ContextCompat.getColor(this, R.color.secondaryTextColor))
